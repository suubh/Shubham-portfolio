...
exports.getNodesFromCacheByValue = exports.ensureIndexByElemMatch = exports.ensureIndexByQuery = void 0;
...
const ensureIndexByQuery = (op, filterCacheKey, filterPath, nodeTypeNames, filtersCache) => {
  ...
  if (nodeTypeNames.length === 1) {
    (0, _.getNodesByType)(nodeTypeNames[0]).forEach(node => {
